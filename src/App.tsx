...
const translations: any = {
    en: {
        ...
        projectDesc2: "An intelligent application utilizing advanced neural networks to evaluate semantic depth of translations with real-world communication flexibility.",
        ...
        whyGroq2: "Groq API: Runs neural networks in the cloud with ultra-low latency.",
    ...
    de: {
        ...
        whyGroq2: "Groq API: Schnelle Cloud-Ausführung neuronaler Netze.",
