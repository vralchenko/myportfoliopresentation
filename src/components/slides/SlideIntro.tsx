    ...
    return (
        ...
        >
            <div className="flex flex-col items-center relative z-0">
                <UserAvatar />
                {/* Master Degree Badge */}
                <div className="flex items-center gap-2 mb-0 bg-purple-500/20 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-purple-500/30 -mt-4">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter mb-0 leading-[1.0] py-1 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 drop-shadow-2xl px-4 scale-90 md:scale-75 origin-center">
                    {t.name}
                </h1>
                <p className="text-lg md:text-2xl text-gray-300 mb-2 font-light tracking-wide max-w-4xl">
                    {t.role}
                </p>

                <div className="flex flex-wrap justify-center gap-3 md:gap-6 max-w-4xl mb-4 md:mb-6">
