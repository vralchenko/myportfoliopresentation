    ...
    return (
        ...
        >
            <div className="max-w-5xl w-full">
                <h2 className="text-4xl md:text-5xl font-bold mb-8 md:mb-16 text-center text-blue-400">{t.featuresTitle2}</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 pb-20 md:pb-0">
                    ...
                    <div className="bg-slate-900/40 p-6 md:p-8 rounded-3xl border border-white/5">
                        <h3 className="text-2xl md:text-3xl font-bold text-cyan-400 mb-4">⚖️ {t.feat2Title2}</h3>
